...
import { videoStyles2 } from "./videoStyles";
...
const FullScreenVideo = ({ src }) => {
	...
	return (
		<div className={videoStyles2.video_container}>
			<video autoPlay muted loop ref={videoRef} className={videoStyles2.video} src={src} controls={false} />
